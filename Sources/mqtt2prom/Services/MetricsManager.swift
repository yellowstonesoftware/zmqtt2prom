        ...
        for expose in deviceInfo.exposes {
            ...
            switch expose.type {
                ...
                case .binary:
                    ...
                    logger.trace("device \(device.friendlyName) property [\(expose.property)] value: \(value) valueOn: \(String(describing: expose.valueOn)) valueOff: \(String(describing: expose.valueOff)) binaryValue: \(binaryValue)")
